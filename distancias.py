...
caminho_arquivo = 'Análise IA.xlsx'  # Substitua pelo nome correto
...
for mascara, grupo in df.groupby('MÁSCARA G'):
...
caminho_excel = os.path.join(os.getcwd(), 'distancias_entre_cidades.xlsx')
